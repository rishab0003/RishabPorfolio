...
var _a0 = /* @__PURE__ */ new Vec3(), _a1 = /* @__PURE__ */ new Vec3(), _a2 = /* @__PURE__ */ new Vec3(), _a3 = /* @__PURE__ */ new Vec3();
/**
...
var GLTFLoader = class {
	...
	static parseLights(gl, desc, nodes, scenes) {
		...
		nodes.forEach((node) => {
			...
			const lightDesc = lightsDescArray[node.extensions.KHR_lights_punctual.light];
			const light = {
				name: lightDesc.name || "",
